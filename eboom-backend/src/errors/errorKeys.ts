...
export const ErrorKeys = {
  ...
  asset: {
    ...
    volumeNotFound: "errors.asset.volumeNotFound",
    volumeCreateFailed: "errors.asset.volumeCreateFailed",
    volumeUpdateFailed: "errors.asset.volumeUpdateFailed",
    volumeDeleteFailed: "errors.asset.volumeDeleteFailed",
    volumeFetchFailed: "errors.asset.volumeFetchFailed",
    invalidVolumeId: "errors.asset.invalidVolumeId",
    pricePointNotFound: "errors.asset.pricePointNotFound",
    pricePointCreateFailed: "errors.asset.pricePointCreateFailed",
    pricePointUpdateFailed: "errors.asset.pricePointUpdateFailed",
    pricePointDeleteFailed: "errors.asset.pricePointDeleteFailed",
    pricePointFetchFailed: "errors.asset.pricePointFetchFailed",
    invalidPricePointId: "errors.asset.invalidPricePointId",
    quantityRequired: "errors.asset.quantityRequired",
    quantityNonZero: "errors.asset.quantityNonZero",
    unitPriceRequired: "errors.asset.unitPriceRequired",
    unitPriceNonNegative: "errors.asset.unitPriceNonNegative",
    unitPricePointRequired: "errors.asset.unitPricePointRequired",
    unitPricePointNonNegative: "errors.asset.unitPricePointNonNegative",
    insufficientQuantity: "errors.asset.insufficientQuantity",
    recordedAtInvalid: "errors.asset.recordedAtInvalid",
    currencyLocked: "errors.asset.currencyLocked",
  },
  auth: {
