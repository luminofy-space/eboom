...
INSERT INTO identity.users (id, email, first_name, last_name, email_verified, password_hash, photo_url, created_at, last_modified_at)
VALUES
...
SELECT setval(pg_get_serial_sequence('identity.users', 'id'), GREATEST((SELECT MAX(id) FROM identity.users), 2));
...
SELECT
  (SELECT id FROM reference.roles WHERE name = 'Collaborator' ORDER BY id LIMIT 1) AS role_collaborator,
  (SELECT id FROM reference.roles WHERE name = 'Modifier' ORDER BY id LIMIT 1) AS role_modifier,
  (SELECT id FROM reference.roles WHERE name = 'Visitor' ORDER BY id LIMIT 1) AS role_visitor,
  (SELECT id FROM reference.currencies WHERE code = 'USD' ORDER BY id LIMIT 1) AS cur_usd,
  (SELECT id FROM reference.currencies WHERE code = 'EUR' ORDER BY id LIMIT 1) AS cur_eur,
  (SELECT id FROM reference.currencies WHERE code = 'GBP' ORDER BY id LIMIT 1) AS cur_gbp,
  (SELECT id FROM reference.currencies WHERE code = 'BTC' ORDER BY id LIMIT 1) AS cur_btc,
  (SELECT id FROM reference.wallet_categories WHERE name = 'Checking Account' ORDER BY id LIMIT 1) AS wc_checking,
  (SELECT id FROM reference.wallet_categories WHERE name = 'Savings Account' ORDER BY id LIMIT 1) AS wc_savings,
  (SELECT id FROM reference.wallet_categories WHERE name = 'Credit Card' ORDER BY id LIMIT 1) AS wc_credit,
  (SELECT id FROM reference.wallet_categories WHERE name = 'Crypto Wallet' ORDER BY id LIMIT 1) AS wc_crypto,
  (SELECT id FROM reference.wallet_categories WHERE name = 'Investment Account' ORDER BY id LIMIT 1) AS wc_investment,
  (SELECT id FROM reference.wallet_categories WHERE name = 'Cash on Hand' ORDER BY id LIMIT 1) AS wc_cash,
  (SELECT id FROM reference.income_categories WHERE name = 'Salary' ORDER BY id LIMIT 1) AS ic_salary,
  (SELECT id FROM reference.income_categories WHERE name = 'Freelance' ORDER BY id LIMIT 1) AS ic_freelance,
  (SELECT id FROM reference.income_categories WHERE name = 'Side Hustle' ORDER BY id LIMIT 1) AS ic_side,
  (SELECT id FROM reference.income_categories WHERE name = 'Investment Returns' ORDER BY id LIMIT 1) AS ic_investment,
  (SELECT id FROM reference.income_categories WHERE name = 'Business Income' ORDER BY id LIMIT 1) AS ic_business,
  (SELECT id FROM reference.expense_categories WHERE name = 'Housing' ORDER BY id LIMIT 1) AS ec_housing,
  (SELECT id FROM reference.expense_categories WHERE name = 'Utilities' ORDER BY id LIMIT 1) AS ec_utilities,
  (SELECT id FROM reference.expense_categories WHERE name = 'Groceries' ORDER BY id LIMIT 1) AS ec_groceries,
  (SELECT id FROM reference.expense_categories WHERE name = 'Subscriptions' ORDER BY id LIMIT 1) AS ec_subscriptions,
  (SELECT id FROM reference.expense_categories WHERE name = 'Insurance' ORDER BY id LIMIT 1) AS ec_insurance,
  (SELECT id FROM reference.expense_categories WHERE name = 'Transportation' ORDER BY id LIMIT 1) AS ec_transport,
  (SELECT id FROM reference.expense_categories WHERE name = 'Shopping & Clothing' ORDER BY id LIMIT 1) AS ec_shopping,
  (SELECT id FROM reference.expense_categories WHERE name = 'Communication' ORDER BY id LIMIT 1) AS ec_communication,
  (SELECT id FROM reference.expense_categories WHERE name = 'Food & Dining' ORDER BY id LIMIT 1) AS ec_dining,
  (SELECT id FROM reference.expense_categories WHERE name = 'Travel' ORDER BY id LIMIT 1) AS ec_travel,
  (SELECT id FROM reference.asset_categories WHERE name = 'Vehicle' ORDER BY id LIMIT 1) AS ac_vehicle,
  (SELECT id FROM reference.asset_categories WHERE name = 'Real Estate' ORDER BY id LIMIT 1) AS ac_real_estate,
  (SELECT id FROM reference.asset_categories WHERE name = 'Equipment' ORDER BY id LIMIT 1) AS ac_equipment,
  (SELECT id FROM reference.asset_categories WHERE name = 'Other' ORDER BY id LIMIT 1) AS ac_other;

CREATE TEMP TABLE _demo (entity TEXT PRIMARY KEY, id INT);

INSERT INTO identity.user_settings (user_id, timezone, language, date_format, default_currency_id, notification_enabled)
...
WITH ins AS (
  INSERT INTO identity.canvases (name, description, canvas_type, is_archived, photo_url, created_by, last_modified_by)
...
-- Canvas members
INSERT INTO identity.canvas_members (canvas_id, user_id, role_id, is_owner)
...
INSERT INTO identity.canvas_invitations (canvas_id, invitee_user_id, invitee_email, role_id, invited_by, status, expires_at, responded_at)
...
WITH ins AS (
  INSERT INTO finance.wallets (canvas_id, name, wallet_category_id, photo_url, description, is_archived, created_by, last_modified_by)
...
WITH ins AS (
  INSERT INTO finance.sub_wallets (wallet_id, currency_id, amount)
...
WITH ins AS (
  INSERT INTO finance.incomes (canvas_id, name, currency_id, wallet_id, amount, income_category_id, is_recurring, status, photo_url, created_by, last_modified_by, recurrence_pattern)
...
WITH ins AS (
  INSERT INTO finance.incomes (canvas_id, name, currency_id, wallet_id, amount, income_category_id, is_recurring, status, photo_url, created_by, last_modified_by)
...
-- 50 income entries
INSERT INTO finance.income_entries (income_id, destination_wallet_id, amount, expected_date, received_date, notes, created_by, last_modified_by)
...
WITH ins AS (
  INSERT INTO finance.expenses (canvas_id, name, expense_category_id, currency_id, wallet_id, is_recurring, status, photo_url, created_by, last_modified_by)
...
-- 50 expense payments
INSERT INTO finance.expense_payments (expense_id, source_wallet_id, amount, due_date, paid_date, notes, created_by, last_modified_by)
...
-- Transfers
INSERT INTO finance.transfers (source_wallet_id, destination_wallet_id, source_amount, destination_amount, exchange_rate, transaction_fee, transfer_date, notes, created_by, last_modified_by)
...
WITH ins AS (
  INSERT INTO finance.assets (canvas_id, name, asset_category_id, currency_id, photo_url, description, created_by, last_modified_by)
...
INSERT INTO finance.asset_volumes (asset_id, quantity, unit_price, recorded_at, created_by)
...
FROM finance.assets a JOIN _demo d ON d.id = a.canvas_id AND d.entity = 'canvas_consulting' WHERE a.name = 'Workstation Setup';

-- 80 price points
INSERT INTO finance.price_points (asset_id, unit_price, recorded_at, created_by)
...
WITH ins AS (
  INSERT INTO finance.budgets (canvas_id, currency_id, period_type, period_start, total_limit, alert_threshold_percent, alerts_enabled, name, created_by, last_modified_by)
...
INSERT INTO finance.budget_lines (budget_id, expense_category_id, amount_limit, alert_threshold_percent)
...
-- Savings goals (5)
WITH ins AS (
  INSERT INTO finance.savings_goals (canvas_id, currency_id, name, target_amount, target_date, linked_wallet_id, photo_url, alert_threshold_percent, status, created_by, last_modified_by)
...
INSERT INTO finance.savings_goals (canvas_id, currency_id, name, target_amount, target_date, photo_url, alert_threshold_percent, status, created_by, last_modified_by)
...
INSERT INTO finance.savings_goals (canvas_id, currency_id, name, target_amount, target_date, photo_url, alert_threshold_percent, status, is_archived, created_by, last_modified_by)
...
WITH ins AS (
  INSERT INTO ai.ai_insight_profiles (canvas_id, status, current_step, risk_profile, investment_goals, esg_preferences, financial_knowledge, financial_picture, completed_at, updated_by_user_id)
...
INSERT INTO ai.ai_financial_insights (canvas_id, profile_id, generated_by_user_id, insights, completeness_score, completeness_breakdown, context_summary, model)
SELECT d.id, p.id, 1,
  jsonb_build_array(
...
INSERT INTO ai.ai_insight_profiles (canvas_id, status, current_step, updated_by_user_id)
SELECT d.id, 'draft', 2, 2 FROM _demo d WHERE d.entity = 'canvas_consulting';

INSERT INTO ai.ai_chat_messages (canvas_id, user_id, role, content, model)
...
INSERT INTO workspace.whiteboard_viewports (canvas_id, x, y, zoom)
SELECT d.id, -120.0000, -80.0000, 0.8500 FROM _demo d WHERE d.entity = 'canvas_personal';

INSERT INTO workspace.whiteboard_node_positions (canvas_id, entity_type, entity_id, x, y)
...
INSERT INTO identity.notifications (user_id, title, message, is_read)
VALUES
