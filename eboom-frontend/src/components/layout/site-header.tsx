...
export function SiteHeader() {
  ...
  return (
    <header className="bg-background z-20 flex h-16 shrink-0 items-center justify-between gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
