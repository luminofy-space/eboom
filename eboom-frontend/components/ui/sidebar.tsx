...
function SidebarMenuButton({
  ...
  const button = (
    <Comp
      ...
      className={cn(sidebarMenuButtonVariants({ variant, size }), className, `${isActive ? "bg-[#6D28D9] text-[#E2E8F0]" : ""}`)}
      {...props}
    />
  )
...
function SidebarMenuSkeleton({
  ...
  // Stable random width between 50 to 90% (initialized once per mount).
